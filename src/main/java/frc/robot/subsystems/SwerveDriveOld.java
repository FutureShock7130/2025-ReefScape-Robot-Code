...
public class SwerveDriveOld extends SubsystemBase {
    ...
    private SwerveModuleOld[] modules = new SwerveModuleOld[] {
            new SwerveModuleOld(0, SwerveConstants.MOD0_CONSTANTS),
            new SwerveModuleOld(1, SwerveConstants.MOD1_CONSTANTS),
            new SwerveModuleOld(2, SwerveConstants.MOD2_CONSTANTS),
            new SwerveModuleOld(3, SwerveConstants.MOD3_CONSTANTS)
    };
    private SwerveDriveKinematics kinematics = new SwerveDriveKinematics(SwerveConstants.MODULE_TRANSLATION_METERS);
    private SwerveDriveOdometry odometry = new SwerveDriveOdometry(kinematics, getGyroYaw(), getModulePositions());

    private Field2d field = new Field2d();

    private static SwerveDriveOld mInstance;

    public static SwerveDriveOld getInstance() {
        if (mInstance == null) {
            mInstance = new SwerveDriveOld();
        }
        return mInstance;
    }
    ...
    public void setModuleStates(SwerveModuleState[] desiredStates) {
        ...
        for (SwerveModuleOld mod : modules) {
